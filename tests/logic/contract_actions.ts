...
const network = 'https://api.testnet.v1.sonic.game'
...
const programId = new PublicKey('3JMqhHBkh9vFciBjzMAy9x3ksyKnSC2UbTbQr4atkVBo')
...
async function init_spl_or_native_program(initType: number) {
  ...
  let poolToken = PublicKey.findProgramAddressSync([Buffer.from("program_token_seed"), tokenMint.toBytes()], program.programId)[0]
